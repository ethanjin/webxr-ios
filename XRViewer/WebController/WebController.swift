...
class WebController: NSObject, WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler {
    ...
    func userContentController(_ userContentController: WKUserContentController, didReceive message: WKScriptMessage) {
        //print(@"Received message: %@ , body: %@", [message name], [message body]);
        ...
        if message.name == WEB_AR_INIT_MESSAGE {
            ...
            print("Init AR send - \(params.debugDescription)")
            ...
            onHitTest?(type, x, y, { results in
                //print(@"Hit test - %@", [results debugDescription]);
            ...
            print("Unknown message: \(message.body) ,for name: \(message.name)")
        }
    ...
    func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
        print("didFinishNavigation - \(navigation.debugDescription)")
